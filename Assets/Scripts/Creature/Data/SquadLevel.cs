...
namespace Creature.Data
{
    public class SquadLevel
    {
        ...
        {
            Managers.SquadBattleManager.Instance.squadEntireStat.UpdateTotalStat(Enum.SquadStatType.Attack, IncreaseAttack * (CurrentLevel - 1));
            Managers.SquadBattleManager.Instance.squadEntireStat.UpdateTotalStat(Enum.SquadStatType.Health, IncreaseHealth * (CurrentLevel - 1));
            Managers.SquadBattleManager.Instance.squadEntireStat.UpdateTotalStat(Enum.SquadStatType.Defence, IncreaseDefence * (CurrentLevel - 1));
        }
        ...
        {
            Managers.SquadBattleManager.Instance.squadEntireStat.UpdateTotalStat(Enum.SquadStatType.Attack, IncreaseAttack);
            Managers.SquadBattleManager.Instance.squadEntireStat.UpdateTotalStat(Enum.SquadStatType.Health, IncreaseHealth);
            Managers.SquadBattleManager.Instance.squadEntireStat.UpdateTotalStat(Enum.SquadStatType.Defence, IncreaseDefence);
        }
    }
}