...
using Creature.MonsterScripts.MonsterFSM;
...
namespace Creature.MonsterScripts.MonsterClass
{
    public class MonsterNew : CreatureClass.Creature
    {
        [Header("Class")]
        ...
        {
            foreach (var allSprite in allSprites)
            {
                monsterSprites.Add(allSprite.sprite);
            }
        }
